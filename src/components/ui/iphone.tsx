...
import deliveryAnimation from "../../assets/lottie/online shopping delivery.json";
...
export function Iphone({
  ...
  return (
    ...
    >
      {hasVideo && (
        <div
          className="pointer-events-none absolute z-0 overflow-hidden flex items-center justify-center"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
